...
<h2 class="title title-color">Registro de clientes</h2>
...
<form action="{{route('clientes.guardarcliente')}}" method="POST">
@csrf
@if(session('mensaje'))
...
<p class="divisor-text">Datos generales</p>
  <div class="form-row">
      <div class="form-group col-md-5">
        <label class="font-weight-bold" for="inputNombre">*Nombre</label>
        <input name="nombre" type="text" class="form-control" id="inputNombre" placeholder="Ingrese el o los nombres del cliente" value="{{old('nombre')}}">
      </div>
    <div class="form-group col-md-5">
      <label class="font-weight-bold" for="inputApellido">*Apellido</label>
      <input name="apellido" type="text" class="form-control" id="inputApellido" placeholder="Ingrese el ó los apellidos del cliente" value="{{old('apellido')}}">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-3">
      <label class="font-weight-bold" for="inputEdad">*Edad</label>
      <input name="edad_cliente" type="number" class="form-control" id="inputEdad" value="{{old('edad')}}">
    </div>
    <div class="form-group col-md-3">
      <label class="font-weight-bold" for="inputFechaNacimiento">*Fecha de nacimiento</label>
      <input name="fecha_nacimiento_cliente" type="date" class="form-control" id="inputFechaNacimiento"value="{{old('fecha_nacimiento_cliente')}}">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-5">
      ...
      <input name="curp" type="text" class="form-control" id="inputcurp" value="{{old('curp')}}">
    </div>
    <div class="form-group col-md-5">
      <label class="font-weight-bold" for="inputrfc">*RFC</label>
      <input name="rfc" type="text" class="form-control" id="inputrfc" value="{{old('rfc')}}">
    </div>
  </div>
  </div>
  <div class="box-formulary">
  ...
  <div class="form-row">
    <div class="form-group col-md-5">
      ...
      <input name="dependencia" type="text" class="form-control" id="inputDependencia" value="{{old('dependencia')}}">
    </div>
    <div class="form-group col-md-5">
      <label class="font-weight-bold" for="inputIngreso">*Ingreso Mensual</label>
      <input name="ingreso_cliente" type="text" class="form-control" id="inputIngreso" value="{{old('ingreso_cliente')}}">
    </div>
  </div>
  </div>
  <div class="box-formulary">
  ...
  <div class="form-row">
    ...
    <input name="direccion_cliente" type="text" class="form-control" id="inputDireccion" placeholder="Ingrese la dirrecion del cliente" value="{{old('direccion_cliente')}}">
    </div>
    <div class="form-group col-md-3">
    <label class="font-weight-bold" for="inputcp">*Código Postal</label>
    <input name="codigo_postal" type="number"min="0" max="99999"class="form-control" id="inputcp" value="{{old('cp')}}">
    </div>
    <div class="form-group col-md-5">
      <label class="font-weight-bold" for="inputEmail">*Correo Electronico</label>
      <input name="email_cliente" type="email" class="form-control" id="inputEmail" value="{{old('email_cliente')}}">
    </div>
    <div class="form-group col-md-5">
      <label class="font-weight-bold" for="inputeNumeroCliente">*Numero Telefonico</label>
      <input name="numero_cliente" type="number" class="form-control" id="inputeNumeroCliente"min="0" max="9999999999" value="{{old('numero_cliente')}}">
    </div>
  </div>
  </div>
  <div class="box-formulary">
  ...
  <div class="form-group col-md-3">
      ...
      <select id="inputEstadoCivil" class="custom-select" name="estado_civil">
        <option selected></option>
    ...
    <div class="form-group col-md-4">
      ...
      <input name="nombre_conyugue" type="text" class="form-control" id="inputConyugueNombre" value="{{old('nombre_conyugue')}}">
    </div>
    <div class="form-group col-md-3">
      <label class="font-weight-bold" for="inputNumeroConyugue">Telefono del Conyugue</label>
      <input name="numero_conyugue" type="number" class="form-control" id="inputNumeroConyugue"min="0" max="9999999999" value="{{old('numero_conyugue')}}">
    </div>
  </div>
  </div>
  <div class="box-formulary">
  ...
  <div class="form-group col-md-7">
      ...
      <input name="nombre_referencia_uno" type="text" class="form-control" id="inputNombreReferenciaUno" value="{{old('nombre_referencia_uno')}}">
    </div><div class="form-group col-md-4">
      <label class="font-weight-bold" for="inputNumeroReferenciaUno">Telefono</label>
      <input name="numero_referencia_uno" type="number" class="form-control" id="inputNumeroReferenciaUno"min="0" max="9999999999" value="{{old('numero_referencia_uno')}}">
      ...
      <input name="nombre_referencia_dos" type="text" class="form-control" id="inputNombreReferenciaDos" value="{{old('nombre_referencia_dos')}}">
    </div><div class="form-group col-md-4">
      <label class="font-weight-bold" for="inputNumeroReferenciaDos">Telefono</label>
      <input name="numero_referencia_dos" type="number" class="form-control" id="inputNumeroReferenciaDos"min="0" max="9999999999" value="{{old('numero_referencia_dos')}}">
    </div>
  </div>
</div>
